...
class GuiAppControllerTests(unittest.TestCase):
    ...
    def test_refresh_reports_initial_shell_state(self) -> None:
        ...
        self.assertEqual("Needs mount", state.use_route_health_value)
    ...
    def test_start_hosting_and_smoke_test_update_state(self) -> None:
        ...
        self.assertEqual("Needs mount", started.use_route_health_value)
        ...
        self.assertIn("Status: Needs mount", started.use_route_details)
    ...
    def test_configure_openclaw_stages_plan_before_apply(self) -> None:
        ...
        self.assertEqual("Needs mount", staged.use_route_health_value)
        ...
        self.assertIn("Status: Needs mount", staged.use_route_details)
