...
class FakeGuiContinueDiscovery:
...
class GuiAppControllerTests(unittest.TestCase):
    def setUp(self) -> None:
        self.controller = GuiAppController(
            harness=LocalPrototypeHarness(
                ...
                continue_discovery=FakeGuiContinueDiscovery(),
    ...
    def test_refresh_reports_initial_shell_state(self) -> None:
        ...
        self.assertEqual("Not ready", state.use_route_health_value)
        self.assertIn("step 1: choose a shape", state.use_route_health_summary.lower())
        ...
        self.assertIn("choose a shape first", state.use_mount_status_summary.lower())
        self.assertEqual("Not selected", state.mount_consumer_label)
        self.assertIn("Shape: Not selected", state.use_route_details)
        self.assertIn("Mount: Not selected", state.use_route_details)
        self.assertIn("Status: Not ready", state.use_route_details)
        self.assertIn("Reason: Choose a shape.", state.use_route_details)
        ...
        self.assertEqual("Not captured", state.route_trace_result_label)
        self.assertIn("No routed execution trace", state.route_trace_summary)
    ...
    def test_start_hosting_and_smoke_test_update_state(self) -> None:
        ...
        self.assertEqual("Not ready", started.use_route_health_value)
        self.assertEqual("", started.mount_selected_shape_id)
        self.assertEqual("Not selected", started.mount_selected_shape_label)
        self.assertEqual("", started.mount_selected_consumer_id)
        self.assertEqual("Choose shape", started.use_mount_status_value)
        self.assertEqual("Not selected", started.mount_consumer_label)
        self.assertIn("step 1: choose a shape", started.use_route_health_summary.lower())
        self.assertIn("Shape: Not selected", started.use_route_details)
        self.assertIn("Mount: Not selected", started.use_route_details)
        self.assertIn("Status: Not ready", started.use_route_details)
        self.assertIn("Reason: Choose a shape.", started.use_route_details)
    ...
    def test_configure_openclaw_stages_plan_before_apply(self) -> None:
        ...
        self.assertEqual("Not ready", staged.use_route_health_value)
        self.assertEqual("", staged.mount_selected_shape_id)
        self.assertEqual("", staged.mount_selected_consumer_id)
        self.assertEqual("Choose shape", staged.use_mount_status_value)
        self.assertIn("Shape: Not selected", staged.use_route_details)
        self.assertIn("Mount: Not selected", staged.use_route_details)
        self.assertIn("Status: Not ready", staged.use_route_details)
        self.assertIn("Reason: Choose a shape.", staged.use_route_details)
    ...
    def test_select_mount_shape_changes_mount_surface_before_consumer_config(self) -> None:
        state = self.controller.select_mount_shape("ollama")
        ...
        self.assertIn("choose a compatible consumer next", state.use_mount_status_summary.lower())
        self.assertIn("step 2: choose a consumer", "\n".join(state.mount_detail_lines).lower())
